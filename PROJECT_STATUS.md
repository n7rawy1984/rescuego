...
| Next migration number | 054. Phase 3 of tiered dispatch (`submit_quote_atomic` rewrite consuming `get_provider_limits`, job_credit_balance consumption mechanism, selection-timeout unification) is planned next per `TIERED_DISPATCH_051_ANALYSIS.md` D1–D6 + session resolutions R1–R6. |
